    ...
    public class DA_RebarTable
    {
        ...
        public void RebarTable()
        {
            ...
            using (Transaction trans = db.TransactionManager.StartTransaction())
            {
                ...
                if (diaRes.Status != PromptStatus.OK) return;
                ...
                for (int i = 0; i < dia.Length; i++)
                {
                    ...
                    unitWeight[i] = Math.Pow(dia[i], 2) * Math.PI / 4 * 7.85 / 1000;
            ...
            using (Transaction trans1 = db.TransactionManager.StartTransaction())
            {
                ...
                for (int i = 0; i < dia.Length; i++)
                {
                    ...
                    ttlTxt.TextString = totalLen[i].ToString("F1");
